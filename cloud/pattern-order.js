...
exports.makePattern = function (search_string) {
...
exports.orderResults = function(books, query){
    ...
    queryWords = query.match(exports.makePattern(query)); 
    _.each(books, function(book, key, list){
        book.weight = 0;
        //FOUND-----------------
        find = book.get('title').match(exports.makePattern(query));
        ...
        _.each(find, function(wordFind, key, list){
            if(key == 0){
                _.find(queryWords, function(wordQuery, keyQuery, listQuery){
                    if(wordFind.match(exports.makePattern(wordQuery))){
                        order++;
                        return true;
                    }else if(book.get('title').match(exports.makePattern(wordQuery))){
                        return true;
                    }
                });
                ...
                findWord = _.find(queryWords, function(wordQuery, key, list){
                    return wordQuery.match(exports.makePattern(wordFind));
                });
                ...
                if (typeof(prevWordQuery) != 'undefined') {
                    equalsPrev = false;
                    equalsPrev = prevWord.match(exports.makePattern(prevWordQuery));
                    if (equalsPrev) {
                        order++;
                    }
                }
